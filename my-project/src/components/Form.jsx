        ...
        <div className="mt-10">
          ...
          <div className="grid grid-cols-2 gap-[80px] pl-8">
            ...
            <div>
              ...
              <div className="relative w-full border-t-2 border-black border-dotted">
                <p className="pl-5 inputFont">
                  <span>2023-24/{workOrderNo}</span>
                </p>
                <p className="absolute -top-[15px] -left-10 text-[13px]">
                  সংখ্যা
                </p>
          ...
          <table className="mt-3 w-full text-center">
            ...
            <tr>
              ...
              <td className="inputFont text-left pl-4">
                <p className="inputFont">
                  <span>{parts}</span> <span>{size}</span>
                </p>
                <div>
                  {items ? (
                    <>
                      <p className="inputFont">{items[0]}</p>
                      <p className="inputFont">{items[1]}</p>
                      <p className="inputFont">{items[2]}</p>
                      <p className="inputFont">{items[3]}</p>
                      <p className="inputFont">{items[4]}</p>
                      <p className="inputFont">{items[5]}</p>
                    </>
                  ) : (
                    ""
                  )}
